...
public class QuizController {
	...
	public String addQuestion(@RequestParam Integer lessonId, RedirectAttributes ra) {
		...
		return "redirect:/teacher-creates-course?courseId=" + lesson.getModule().getCourse().getCourseId()
				+ "&openModule=" + lesson.getModule().getModuleId() + "&openQuiz=" + lesson.getLessonId() + "#quiz-"
				+ lesson.getLessonId();
	}
	...
	public String updateQuiz(@RequestParam Integer lessonId, @RequestParam List<Integer> questionIds,
			@RequestParam List<String> questionTexts, @RequestParam List<String> optionAs,
			@RequestParam List<String> optionBs, @RequestParam List<String> optionCs,
			@RequestParam List<String> optionDs, @RequestParam List<String> correctOptions, RedirectAttributes ra) {
	...
	public String deleteQuestion(@RequestParam Integer questionId, RedirectAttributes ra) {
		...
		return "redirect:/teacher-creates-course?courseId=" + courseId + "&openModule=" + moduleId + "&openQuiz="
